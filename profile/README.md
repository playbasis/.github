# Playbasis Legacy Open Source Reset
...
The current open source reset is intentionally conservative. The goal is to make the existing codebase easier to run, inspect, document, secure, and migrate from while preserving behavior.
